...
type UserServiceClient interface {
	...
	GetUsersByIds(ctx context.Context, in *GetUsersRequest, opts ...grpc.CallOption) (*UserList, error)
}
...
func (c *userServiceClient) GetUsersByIds(ctx context.Context, in *GetUsersRequest, opts ...grpc.CallOption) (*UserList, error) {
	out := new(UserList)
...
type UserServiceServer interface {
	...
	GetUsersByIds(context.Context, *GetUsersRequest) (*UserList, error)
...
func (UnimplementedUserServiceServer) GetUsersByIds(context.Context, *GetUsersRequest) (*UserList, error) {
